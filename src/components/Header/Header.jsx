      ...
      <div className="max-w-6xl mx-auto relative z-10 lg:mt-20 lg:mb-28">
        <div className="lg:flex flex-wrap items-center justify-between gap-4">
          <div className="space-y-4 mb-4">
            <p className="text-[#b69d78]">Best Selling Book</p>
            <h1 className="lg:text-5xl md:text-4xl  text-3xl font-bold text-[#19150f] ">
            ...
            <button className="flex items-center text-white hover:text-[#19150f] bg-[#b69d78] px-4 py-2 border border-[#b69d78]">
              <span className="">
